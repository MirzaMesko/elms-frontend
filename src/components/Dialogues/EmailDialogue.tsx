...
const EmailDialog: React.FC<OwnProps> = (props: OwnProps) => {
  const { show, close, emailSubject, emailText, sendEmail, recepientsEmail } = props;
  const [open, setOpen] = React.useState(show);
  const [subject, setSubject] = React.useState<string>('');
  const [subjectWarning, setSubjectWarning] = React.useState<string>('');
  const [text, setText] = React.useState<string>('');
  const [textWarning, setTextWarning] = React.useState<string>('');
